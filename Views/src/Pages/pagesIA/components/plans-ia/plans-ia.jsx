...
function PlansIa({props_label, props_title_box,props_link}){
    return(
        <>
       ...
       <Link to={props_link}><input type="submit" className='input-plans-purple-ia' value={"Assinar o plano"} /></Link>
       </div>
        </>
    )
