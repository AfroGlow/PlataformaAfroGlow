            ...
            <div id="carouselExample" class="carousel slide">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <Link to="/login"><img src="CarroselJogo.svg" class="d-block w-100"  alt='carrosel de imagens'/></Link>
                </div>
                <div class="carousel-item">
                  <Link to="/login"><img src="CarroselJogoDois.png" class="d-block w-100" alt='carrosel de imagens'/></Link>
                </div>
                <div class="carousel-item">
                  <Link to="/login"><img src="CarroselJogoTres.png" class="d-block w-100" alt='carrosel de imagens'/></Link>
                </div>
                <button
          ...
          <div className="plans" id='plans'>
            ...
            <div className="plansCards">
              <div className="plansCardContent">
                ...
                <div> <Link to="/cadastro"><button><a href="">Assinar</a></button></Link> </div>
              </div>
              <div className="plansCardContent">
                <div className="plansValue">
                  <p>Plano Premium</p>
          ...
          <div className="socialMedia">
            ...
            <div className="socialMediaContent">
              ...
              <div className="socialMediaIcons">
                <a href="https://www.linkedin.com/company/afroglow2023/about/" target='blank'><img src="iconLinkedin.svg" alt="icone linkedin amarelo" /></a>
                <a href="https://www.tiktok.com/@afroglow_" target='blank'><img src="iconTiktok.svg" alt="icone tiktok amarelo" /></a>
                <a href="https://www.instagram.com/afroglow__/" target='blank'><img src="iconInstagram.svg" alt="icone instagram amarelo" /></a>
                <a href="https://www.youtube.com/channel/UClFAHMPfmqLk13G1T1_ieRQ" target='blank'><img src="iconYoutube.svg" alt="icone youtube amarelo" /></a>
              </div>
            </div>
          </div>
