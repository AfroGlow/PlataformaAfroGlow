            ...
            <div className="headers-responsible">
                ...
                <div className="cards-videos">
                    ...
                    <div className="cards-videos-1">
                        ...
                        <CardsVideos props_img={'../public/video3.png'} props_p={'Venha aprender como hidratar os pequenos cachinhos da forma mais prazerosa.'} props_alt={'criança'} props_video={"/video3"}
                    ...
                    <div className="cards-videos-2">
                        ...
                        <CardsVideos props_img={'../public/video6.jpg'} props_p={'Quais são as formas de finalização para os cabelos encaracolados? Vem aprender!'} props_alt={'criança'} props_video={"/video6"}
                            props_p2={'6:03 minutos'} />
                        <CardsVideos props_img={'../public/video7.jpg'} props_p={'Aprenda algumas maneiras de finalizar o cabelo do seu pequeno.'} props_alt={'criança'} props_video={"/video7"}
                            props_p2={'7:30 minutos'} />
                        <CardsVideos props_img={'../public/video8.jpg'} props_p={'Vamos aos toques finais, e nos preparar para os próximos passos.'} props_alt={'criança'} props_video={"/video8"}
                            props_p2={'10 minutos'} />
                    </div>
                    <div className="title-tutorials-responsible">
                    ...
                    <div className="cards-videos-3">
                        <CardsVideos props_img={'../public/video9.jpg'} props_p={'Vamos fazer penteados incríveis, e tornar um momento de diversão para toda a família!'} props_alt={'criança'} props_video={"/video9"}
                            props_p2={'10 minutos'} />
                        <CardsVideos props_img={'../public/video10.jpg'} props_p={'Aqui você encontra um penteado simples, que demanda pouco tempo e muitos sorrisos.'} props_alt={'criança'} props_video={"/video10"}
                            props_p2={'10 minutos'} />
                        <CardsVideos props_img={'../public/video11.jpg'} props_p={'Esse penteado tem dificuldade média, separe um tempo na sua agenda e divirta-se!'} props_alt={'criança'} props_video={"/video11"}
                            props_p2={'10 minutos'} />
